...
titlesuffix: ''
description: Découvrez-en plus sur la gestion des données et la protection des applications Office 365 dans Microsoft Intune.
keywords: ''
author: Erikre
ms.author: erikre
manager: dougeby
...
![Image de l’invite pour définir et confirmer le code PIN](./media/pin-prompt-android.png)
