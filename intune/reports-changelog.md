...
1. Ouvrez l’application [Conformité Intune (Entrepôt de données)](https://app.powerbi.com/groups/me/getapps/services/Intune_dw_compliance) dans votre navigateur web.
