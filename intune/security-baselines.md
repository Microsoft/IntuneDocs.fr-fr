...
2. Sélectionnez **Bases de référence de sécurité (préversion)**. Vous obtenez la liste des bases de référence disponibles. Au fur et à mesure que davantage de bases de référence sont ajoutées, vous les verrez ici :
