...
- Affichez les paramètres qui sont disponibles dans [la ligne de base de sécurité MDM actuelle](security-baseline-settings-mdm-all.md?pivots=mdm-may-2019).
...
*Cette ligne de base est remplacée par la [ligne de base de sécurité MDM pour mai 2019](security-baseline-settings-mdm-all.md?pivots=mdm-may-2019)*
...
[Afficher la version actuelle de la ligne de base](security-baseline-settings-mdm-all.md?pivots=mdm-may-2019)  
[Mettre à niveau les profils pour utiliser une nouvelle version de référence](security-baselines.md#change-the-baseline-version-for-a-profile)
