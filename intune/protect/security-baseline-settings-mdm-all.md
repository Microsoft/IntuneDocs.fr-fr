...
description: Passez en revue les valeurs par défaut et les paramètres disponibles pour les différentes versions de la base de référence sécurité Windows MDM que vous pouvez gérer avec Microsoft Intune.
author: brenduns
ms.author: brenduns
manager: dougeby
ms.date: 09/06/2019
...
**Préversion : base de référence de la sécurité GPM pour octobre 2018**  
> [!NOTE]  
...
- **Stratégie de lecteur système du dispositif de verrouillage de bits** *(tous les paramètres)*
