...
- [Créer un profil](#create-the-profile) : configurez les paramètres que vous souhaitez utiliser et affectez la base de référence à des groupes.
