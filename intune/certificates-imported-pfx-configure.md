...
- **PFX Certificate Connector pour Microsoft Intune** :  
  ...
  Pour plus d’informations sur tous les points de terminaison réseau auxquels le connecteur accède, consultez [Configuration requise pour le réseau Intune et bande passante](https://docs.microsoft.com/intune/network-bandwidth-use).
