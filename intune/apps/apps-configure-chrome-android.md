...
## <a name="add-an-app-configuration-policy-for-managed-android-enterprise-devices"></a>Ajouter une stratégie de configuration d’applications pour les appareils Android Entreprise gérés
