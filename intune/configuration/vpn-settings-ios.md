...
- **Minimum de la plage de versions TLS** : entrez la version TLS minimale à utiliser. Entrez `1.0`, `1.1` ou `1.2`. Si le champ n’est pas rempli, la valeur par défaut `1.0` est utilisée.
