...
- **Copier et coller (Samsung Knox uniquement)**  : choisissez l’option **Bloquer** pour empêcher les opérations de copier-coller. L’option **Non configuré** autorise les fonctions de copier-coller sur l’appareil.
- **Partage du Presse-papiers entre applications (Samsung KNOX uniquement)** : Choisissez l’option **Bloquer** pour empêcher l’utilisation du Presse-papiers pour effectuer des copier-coller entre les applications. L’option **Non configuré** autorise l’utilisation du Presse-papiers pour effectuer des copier-coller entre les applications.
- **Envoi des données de diagnostic (Samsung Knox uniquement)** : Choisissez **Bloquer** pour empêcher l’utilisateur d’envoyer des données de diagnostic depuis l’appareil. L’option **Non configuré** autorise l’utilisateur à envoyer les données.
...
- **Capture d'écran (Samsung Knox uniquement)** : choisissez l’option **Bloquer** pour empêcher les captures d’écran. L’option **Non configuré** autorise l’utilisateur à capturer le contenu de l’écran comme image.
...
- **Mot de passe** : **Demande** à l’utilisateur final de saisir un mot de passe pour pouvoir accéder à l’appareil. L’option **Non configuré** autorise les utilisateurs à accéder à l’appareil sans entrer de mot de passe.
...
- **Déverrouillage par empreinte digitale (Samsung Knox uniquement)** : choisissez l’option **Bloquer** pour empêcher l’utilisateur de déverrouiller l’appareil avec une empreinte digitale. L’option **Non configuré** autorise l’utilisateur à déverrouiller l’appareil à l’aide d’une empreinte digitale.
...
- Si l’application Portail d’entreprise exécute une version antérieure à 1704, aucune stratégie de code PIN ne s’applique à l’appareil et une erreur s’affiche dans le centre d’administration Microsoft Endpoint Manager.
- Si l’application Portail d’entreprise fonctionne avec la version 1704 ou une version ultérieure, un simple code PIN peut être appliqué. Les versions d’Android antérieures à 5.0 ne gèrent pas ce paramètre. Aucune erreur n’est affichée dans le centre d’administration du gestionnaire de points de terminaison Microsoft.

## <a name="google-play-store"></a>Google Play Store

- **Google Play Store (Samsung Knox uniquement)** : choisissez **Bloquer** pour empêcher l’utilisation du Google Play Store. L’option **Non configuré** autorise l’utilisateur à accéder à Google Play Store sur l’appareil.
...
- **Applications approuvées** : liste des applications que les utilisateurs sont autorisés à installer. Pour rester conformes, ils ne doivent pas installer d’autres applications. Les applications qui sont gérées par Intune sont autorisées automatiquement.
...
- **Ajouter une application de Store** : sélectionnez une application dans la liste des applications gérées dans Intune.
...
- **Synchronisation automatique du compte Google (Samsung Knox uniquement)** : choisissez **Bloquer** pour bloquer la fonctionnalité de synchronisation automatique de compte Google sur l’appareil. L’option **Non configuré** autorise la synchronisation automatique des paramètres du compte Google.
...
- **Composition vocale (Samsung Knox uniquement)** : choisissez l’option **Bloquer** pour empêcher l’utilisation de la fonctionnalité de numérotation vocale sur l’appareil. L’option **Non configuré** autorise la numérotation vocale sur l’appareil.
- **Itinérance vocale (Samsung Knox uniquement)** : choisissez l’option **Bloquer** pour empêcher l’itinérance vocale sur le réseau mobile. L’option **Non configuré** autorise l’itinérance vocale quand l’appareil se trouve sur un réseau cellulaire.
- **Bluetooth (Samsung Knox uniquement)** : choisissez l’option **Bloquer** pour empêcher l’utilisation du Bluetooth sur l’appareil. L’option **Non configuré** autorise l’utilisation du Bluetooth sur l’appareil.
...
- **Connexion Wi-Fi (Samsung Knox uniquement)** : choisissez **Bloquer** pour empêcher la connexion Wi-Fi sur l’appareil. L’option **Non configuré** autorise l’utilisation du partage de connexion Wi-Fi sur l’appareil.
...
- **Bouton de veille de l’écran** : choisissez **Bloquer** pour bloquer ou masquer le bouton de mise en veille de l’écran. L’option **Non configuré** autorise le bouton de sortie de veille de l’écran sur l’appareil.
