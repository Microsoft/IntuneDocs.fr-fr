...
> [!NOTE]
> Les informations de cette rubrique s’appliquent uniquement aux bureaux Windows que vous gérez en tant que PC à l’aide du client logiciel Intune. Si vous souhaitez afficher l’inventaire des PC Windows inscrits en tant qu’appareils mobiles, consultez [afficher les détails des appareils dans Intune](../remote-actions/device-inventory.md).
