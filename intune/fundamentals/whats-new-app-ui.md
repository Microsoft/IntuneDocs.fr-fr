...
## <a name="week-of-february-3-2020"></a>Semaine du 3 février 2020
...
![Exemple de capture d’écran de l’application Portail d’entreprise pour Windows 10 - Page Applications installées ](./media/whats-new-app-ui/installed-apps-cp-1906.png)  
...
### <a name="new-end-user-app-microsoft-intune-app---3903244---"></a>Nouvelle application utilisateur final (application Microsoft Intune) <!--3903244 -->  
...
Si vous avez activé le [mappage de groupe d’appareils](../enrollment/device-group-mapping.md), l’application Portail d’entreprise pour Windows 10 invite maintenant vos utilisateurs à sélectionner une catégorie d’appareils après l’inscription de leur appareil.
...
### <a name="improvements-to-the-app-tiles-in-the-company-portal-app-for-ios---1230777--"></a>Améliorations aux mosaïques de l’application dans l’application de portail d’entreprise pour iOS <!--1230777-->
...
Le portail d’entreprise reçoit également des icônes mises à jour pour les versions Android, iOS et Windows de l’application, afin d’améliorer la cohérence avec d’autres applications dans EM + S. Ces icônes seront disponibles progressivement sur les différentes plateformes, sur une période allant d’avril à fin mai.
...
### <a name="modernizing-the-company-portal-website---753980-announced-1701--"></a>Modernisation du site web Portail d’entreprise <!--753980, announced 1701-->
