...
La première étape consiste à signer le code de votre package appx, consultez [signer le package d’application à l’aide de signtool](https://docs.microsoft.com/windows/uwp/packaging/sign-app-package-using-signtool)

## <a name="upload-your-app"></a>Charger votre application

Ensuite, téléchargez le fichier appx signé, comme décrit dans [l’application Windows métier](lob-apps-windows.md)
