...
Votre entreprise ne peut pas voir vos informations personnelles quand vous inscrivez un appareil avec Microsoft Intune. Quand vous inscrivez un appareil, vous autorisez votre entreprise à voir certains éléments d’information sur votre appareil, comme le modèle de l’appareil et son numéro de série. Votre entreprise utilise ces informations pour protéger les données d’entreprise sur l’appareil.
...
**Ce que votre entreprise pourrait être en mesure de voir :**
